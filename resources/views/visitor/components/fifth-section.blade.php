            ...
            <div class="testimonial-slider" id="testimonial-slider">
                    ...
                    <div class="testimonial-v2">
                        ...
                        <div class="author d-flex">
                            <div class="author-pic">
                                <img src="{{ asset('visitor_assets/images/person_1.jpg')}}" alt="Image" class="img-fluid" />
                            </div>
                ...
                <div class="item">
                    <div class="testimonial-v2">
                        ...
                        <div class="author d-flex">
                            <div class="author-pic">
                                <img src="{{ asset('visitor_assets/images/person_2.jpg')}}" alt="Image" class="img-fluid" />
                            </div>
                            <div class="author-name">
                                <h3>Drew Wood</h3>
                                <span>Director at Google</span>
                ...
                <div class="item">
                    <div class="testimonial-v2">
                        ...
                        <div class="author d-flex">
                            <div class="author-pic">
                                <img src="{{ asset('visitor_assets/images/person_3.jpg')}}" alt="Image" class="img-fluid" />
                            </div>
                            <div class="author-name">
